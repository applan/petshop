...
values(rno_seq.nextVal,'jang1234','1234qwer!','관리자','코리아아이티','ajdzl777@naver.com','1','cat','dog','1');

insert into pet_user(userno,userid,password,username,addr,email,emailcheck,cat,dog,num) 
values(rno_seq.nextVal,'jang12345','1234qwer!','판매자1','코리아아이티','ajdzl77@naver.com','1','cat','dog','2');
insert into pet_user(userno,userid,password,username,addr,email,emailcheck,cat,dog,num) 
values(rno_seq.nextVal,'jang12346','1234qwer!','판매자2','코리아아이티','ajdzl7@naver.com','1','cat','dog','2');

insert into pet_user(userno,userid,password,username,addr,email,emailcheck,cat,dog,num) 
values(rno_seq.nextVal,'jang123','1234qwer!','구매자','코리아아이티','wkd_wo_gus@naver.com','1','cat','dog','3');
